...
let getWeather = (city) => {
  let apiURL1 = "https://pro.openweathermap.org/data/2.5/forecast/hourly?lat={lat}&lon={lon}&appid=" + city + "&units=imperial&appid=6394dad5ed4488cbd7645efb0dd5bf27";
  fetch(apiURL1)
    .then((response) => {
        response.json()
          .then((data) => {
...
let getForecast = (city) => {
  let apiURL3 = "https://pro.openweathermap.org/data/2.5/forecast/hourly?lat={lat}&lon={lon}&appid=" + city + "&units=imperial&appid=6394dad5ed4488cbd7645efb0dd5bf27";
  fetch(apiURL3)
    .then((response) => {
      response.json()
        .then((data) => {
